...
```
<picture>
   <source media="(min-width: 650px)" srcset="pigs.webp" type="image/webp"> source 1
   <source media="(min-width: 465px)" srcset="pigs.jpeg" type="image/jpeg"> source 2
   <img src="pigs.jpg" alt="two piggies"/> // fallback source
</picture>
```
